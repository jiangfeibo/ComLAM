...
* [A Comprehensive Survey of Large AI Models for Communications: Foundations, Applications, and Future Directions](#)
  ...
  * [I.INTRODUCTION](#IINTRODUCTION)
    * [A. Background](#)
      * [1) Traditional machine learning-assisted communication](#1Traditional machine learning-assisted communication)
      * [2) Deep supervised learning-assisted communication](#2Deep supervised learning-assisted communication)
      * [3) Deep reinforcement learning-assisted communication](#3Deep reinforcement learning-assisted communication)
      * [4) Generative AI-assisted communication](#4Generative AI-assisted communication)
    * [B. Motivation](#)
  ...
  * [III. DESIGN FOUNDATIONS OF LAMS FOR COMMUNICATIONS](#大模型在语义通信的应用)
    * [A. Key architecture of LAMs](#1AIGC增强的语义通信系统)
      ...
      * [4) Mamba](#1网络安全威胁检测与防御)
    * [B. Classification of LAMs](#2通信网络中的可信AI)
      * [1) Large language model](#模型在新兴应用的应用)
      * [2) Large vision model](#1数字孪生)
      * [3) Vision-language model](#2智慧医疗)
      * [4) Large multimodal model](#3元宇宙)
      * [5) World model](#4其他领域)
      * [6) Lightweight large AI model](#4其他领域)
    * [C. Optimization of LAMs](#2通信网络中的可信AI)
      * [1) In-context learning](#模型在新兴应用的应用)
      * [2) X of thought](#1数字孪生)
      * [3) Retrieval-augmented generation](#2智慧医疗)
      * [4) Multi-agent system](#3元宇宙)
      * [5) Mixture of experts](#4其他领域)
  * [IV. LAMS FOR PHYSICAL LAYER DESIGN](#大模型在语义通信的应用)
    * [A. LLM-assisted physical layer design](#1AIGC增强的语义通信系统)
    * [B. GAI model-assisted physical layer design](#智能体驱动的语义通信系统)
  * [V. LAMS FOR RESOURCE ALLOCATION AND OPTIMIZATION](#大模型在安全隐私的应用)
    * [A. Computing resource allocation](#1网络安全威胁检测与防御)
    * [B. Spectrum resource allocation](#2通信网络中的可信AI)
    * [C. Energy resource optimization](#模型在新兴应用的应用)
  * [VI. LAMS FOR NETWORK DESIGN AND MANAGEMENT](#大模型在语义通信的应用)
    * [A. Network design](#1AIGC增强的语义通信系统)
    * [B. Network management](#智能体驱动的语义通信系统)
  * [VII. LAMS FOR EDGE INTELLIGENCE](#大模型在安全隐私的应用)
    * [A. Edge training and application of LAMs](#1网络安全威胁检测与防御)
    * [B. Edge resource scheduling meets LAMs](#2通信网络中的可信AI)
    * [C. Cross-domain collaboration of LAMs](#模型在新兴应用的应用)
  * [VIII. LAMS FOR SEMANTIC COMMUNICATION](#大模型在安全隐私的应用)
    * [A. LLM-based semantic communication systems](#1网络安全威胁检测与防御)
    * [B. Other LAM-based semantic communication systems](#2通信网络中的可信AI)
  * [IX. LAMS FOR FEDERATED LEARNING](#大模型在安全隐私的应用)
    * [A. Federated fine-tuning for LAMs](#1网络安全威胁检测与防御)
    * [B. Personlized federated learning for LAMs](#2通信网络中的可信AI)
  * [X. LAM-BASED AGENT SYSTEMS](#大模型在安全隐私的应用)
    * [A. Agent systems based on LLMs](#1网络安全威胁检测与防御)
    * [B. Agent systems based on other GAI models](#2通信网络中的可信AI)
  * [XI. LAMS FOR SECURITY AND PRIVACY](#模型在新兴应用的应用)
    * [A. Network threat detection and defense](#1网络安全威胁检测与防御)
    * [B. Trusted AI in communication networks](#2通信网络中的可信AI)
  * [XII. LAMS FOR DIGITAL TWIN AND METAVERSE](#模型在新兴应用的应用)
    * [A. LAMs for digital twin](#1网络安全威胁检测与防御)
    * [B. GAI models for metaverse](#2通信网络中的可信AI)
  * [XIII. LAMS FOR EMERGING APPLICATIONS](#模型在新兴应用的应用)
    * [A. Smart healthcare](#1网络安全威胁检测与防御)
    * [B. Carbon emissions](#2通信网络中的可信AI)
    * [C. Automation systems](#1网络安全威胁检测与防御)
    * [D. Artificial intelligence of things](#2通信网络中的可信AI)
    * [E. Integrated satellite, aerial, and terrestrial networks](#1网络安全威胁检测与防御)
    * [F. Integration of UAVs and LLMs](#2通信网络中的可信AI)
  * [XIV. RESEARCH CHALLENGES](#模型在新兴应用的应用)
    * [A. The lack of communication data and knowledge](#1网络安全威胁检测与防御)
      * [1) The lack of communication data](#2通信网络中的可信AI)
      * [2) The lack of communication knowledge](#1网络安全威胁检测与防御)
    * [B. Insufficient logical reasoning capabilities](#2通信网络中的可信AI)
      * [1) Limitations in logical understanding](#1网络安全威胁检测与防御)
      * [2) Limitations in logical reasoning](#2通信网络中的可信AI)
    * [C. Inadequate explanation and evaluation mechanisms](#1网络安全威胁检测与防御)
      * [1) Deficient explanation mechanism](#2通信网络中的可信AI)
      * [2) Insufficient evaluation mechanism](#1网络安全威胁检测与防御)
    * [D. Difficulties in the deployment of LAMs](#2通信网络中的可信AI)
      * [1) Hardware resource limitation](#1网络安全威胁检测与防御)
      * [2) Communication resources limitation](#2通信网络中的可信AI)
  * [XV. FUTURE RESEARCH DIRECTIONS](#模型在新兴应用的应用)
    * [A. Continual learning for LAMs](#1网络安全威胁检测与防御)
      * [1) Continual learning algorithms](#2通信网络中的可信AI)
      * [2) Continual learning evaluation](#1网络安全威胁检测与防御)
    * [B. Agentic AI](#2通信网络中的可信AI)
      * [1) Single-agent optimization](#1网络安全威胁检测与防御)
      * [2) Multi-agent optimization](#2通信网络中的可信AI)
    * [C. Explainable LAMs](#1网络安全威胁检测与防御)
      * [1) Interpretable model](#2通信网络中的可信AI)
      * [2) Interpretable evaluations](#1网络安全威胁检测与防御)
    * [D. Efficient deployment of LAMs](#2通信网络中的可信AI)
      * [1) Pruning](#1网络安全威胁检测与防御)
      * [2) Quantization](#2通信网络中的可信AI)
      * [3) Knowledge distillation](#1网络安全威胁检测与防御)
  * [The Team](#团队)
  * [Acknowledgments](#致谢)
  * [Update log](#更新日志)
